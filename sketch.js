...
function setup() {
  ...
  startButton.position(width / 2 + 800, height / 2 + 450);
  startButton.size(120, 40);
  startButton.mousePressed(startGame);

  backToMenuButton = createButton('Back to Menu');
  backToMenuButton.position(width / 2 + 800, height / 2 + 450);
...
function room1() {
  ...
  fill(255, 255, 255, 150);
  rect(width - 360, 20, 360, 40);
  fill(0);
  textSize(16);
  textFont('Courier New');
  textStyle(BOLD);
  textAlign(LEFT, CENTER);  
  text("Objective: Find the Orb to the Door", width - 350, 40);
}
...
function room2() {
  ...
  textStyle(BOLD);
  textAlign(LEFT, CENTER);  
  text("Objective: Collect all the Souls", width - 350, 40);
}
